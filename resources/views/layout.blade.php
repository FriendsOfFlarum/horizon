...
<head>
    ...
    <link href="{{ $cssLightUrl }}" rel="stylesheet" data-scheme="light" />
    <link href="{{ $cssDarkUrl }}" rel="stylesheet" data-scheme="dark" />
</head>
<body>
        ...
        <div class="d-flex align-items-center py-4 header">
            <router-link to="/dashboard" class="logo d-flex align-items-center">
                ...
                <h1 class="h4 mb-0 ml-2">
                    <strong>Laravel</strong> Horizon{{ $forumTitle ? ' - ' . $forumTitle : '' }}
                </h1>
            </router-link>
            ...
            <div class="col-10">
                @if (! $assetsAreCurrent)
                    <div class="alert alert-warning">
                        The published Horizon assets are not up-to-date with the installed version.
                    </div>
                @endif
