...
return [
    ...
    (new Flarum\Console())
        ...
        ->command(Laravel\ClearCommand::class)
        ->command(Console\PauseCommand::class)
        ->command(Console\ContinueCommand::class)
        ->command(Laravel\PauseSupervisorCommand::class)
        ->command(Laravel\ContinueSupervisorCommand::class)
